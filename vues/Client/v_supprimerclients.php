...
<html>
    ...
    <form action="index.php?uc=supprimerMoniteur&action=confirmSuppressionMoniteur" method="post">
		...
		<tbody>
			...
			<tr><td>Téléphone </td><td><input name="Cdate" size=50 value= "<?php echo $tel ?>" readonly></td></tr>	
			<tr><td>Date du code</td><td><input name="Cdate" size=50 value= "<?php echo $code ?>" readonly></td></tr>	
			<tr><td>Date du permis </td><td><input name="Cdate" size=50 value= "<?php echo $permis ?>" readonly></td></tr>	
			<tr><td>Méthode de paiement</td><td><input name="Cdate" size=50 value= "<?php echo $paiement ?>" readonly></td></tr>	
		</tbody>
		</table>
